                    ...
                    <Grid.Row columns="3" >
                        <Grid.Column >
                           <a href="https://www.telegrama.ro/social/economie/grupul-lukoil-i-a-premiat,-cu-cate-6-000-de-dolari,-pe-ca%C8%99tigatorii-primei-edi%C8%9Bii-a-concursului-de-proiecte-sociale-%C8%99i-culturale-pe-care-l-a-organizat-in-romania-galerie-foto.html" 
                               rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/AGkljKQ.jpg'} /></a> 
                        </Grid.Column>

                        <Grid.Column>
                           <a href="https://www.youtube.com/watch?v=F1K1P823dao" 
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/2cH7mRn.png'} /></a> 
                        </Grid.Column>

                        <Grid.Column>
                           <a href="https://eduscoala.ro/revista/nr20/" 
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/kbHlXMn.png'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={"https://i.imgur.com/nE5dRTy.png"} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/PmMy5CD.png'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/f0SRcBd.png'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/WK3Fjxo.jpg'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/cnsOpr8.png'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/AOaxnta.png'} /></a> 
                        </Grid.Column>
                        ...
                        <Grid.Column>
                          ...
                          rel="noopener noreferrer" target="_blank"> <Card centered fluid raised image={'https://i.imgur.com/31RZeAh.png'} /></a> 
                        </Grid.Column>
